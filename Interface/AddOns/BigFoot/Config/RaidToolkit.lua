...
function RaidToolkitConfigFunc()
	...
	if ( IsConfigurableAddOn("Recount") or IsConfigurableAddOn("DBM-Core") or IsConfigurableAddOn("Grid") or IsConfigurableAddOn("RaidAlerter") or IsConfigurableAddOn("Skada") or IsConfigurableAddOn("MeetingStone") or IsConfigurableAddOn("Omen") or (IsConfigurableAddOn("Decursive") and (playerClass ~= "WARRIOR" and playerClass ~= "ROGUE" and playerClass ~= "DEATHKNIGHT") ) ) then
