...
-- Remove the slash handlers used to load the addon
if hash_SlashCmdList["/THOGAR"] then
	hash_SlashCmdList["/THOGAR"] = nil
end
if hash_SlashCmdList["/THOGARASSIST"] then
	hash_SlashCmdList["/THOGARASSIST"] = nil
end
